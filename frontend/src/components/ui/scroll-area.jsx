  ...
  return (/*#__PURE__*/
    _jsxs(ScrollAreaPrimitive.Root, {
      ...
      _jsx(ScrollAreaPrimitive.Viewport, {
        ...
        className: "focus-visible:ring-ring/50 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1", children:
...
function ScrollBar({
  ...
  return (/*#__PURE__*/
    _jsx(ScrollAreaPrimitive.ScrollAreaScrollbar, {
      ...
      _jsx(ScrollAreaPrimitive.ScrollAreaThumb, {
