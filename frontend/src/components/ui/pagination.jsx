...
function PaginationItem({ ...props }) {
  return /*#__PURE__*/_jsx("li", { "data-slot": "pagination-item", ...props });
}
...
function PaginationNext({
  ...
  return (/*#__PURE__*/
    _jsxs(PaginationLink, {
      ...
      _jsx("span", { className: "hidden sm:block", children: "Next" }), /*#__PURE__*/
...
function PaginationEllipsis({
  ...
  return (/*#__PURE__*/
    _jsxs("span", {
      ...
      _jsx(MoreHorizontalIcon, { className: "size-4" }), /*#__PURE__*/
