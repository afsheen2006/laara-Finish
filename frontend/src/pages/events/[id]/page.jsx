...
import { Calendar, MapPin, ChevronLeft, ArrowRight, Sparkles, AlertCircle, Info } from "lucide-react";
...
export default function EventDetailPage() {
  ...
  if (loading) {
    return _jsx("div", { className: "min-h-screen bg-background text-foreground flex items-center justify-center font-medium", children: "Loading Event Details..." });
  }
  ...
  if (!event) {
    return _jsxs("main", { className: "min-h-screen bg-background text-foreground flex flex-col justify-between", children: [
      _jsx(Navigation, { customLinks: navLinks, config: config }),
  ...
  return _jsxs("main", { className: "min-h-screen bg-background text-foreground selection:bg-primary selection:text-black flex flex-col justify-between", children: [
    _jsx(Navigation, { customLinks: navLinks, config: config }),
